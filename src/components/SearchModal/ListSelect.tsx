...
import { Button, Text, ChevronDownIcon, CloseIcon } from '@flash-swap/uikit'
        ...
        <Text bold>
          ...
          <QuestionHelper
            text={TranslateString(
              999,
              'Token lists are an open specification for lists of CRC20 tokens. You can use any token list by entering its URL below. Beware that third party token lists can contain fake or malicious CRC20 tokens.'
            )}
          />
        </Text>
        <Row>

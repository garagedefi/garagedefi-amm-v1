...
import { Card, CardBody, Text } from '@flash-swap/uikit'
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper
              text={TranslateString(
                230,
                'For each trade a 0.25% fee is paid. 0.17% goes to liquidity providers and 0.08% goes to the DuckyDefi treasury'
              )}
            />
          </RowFixed>
          <Text fontSize="14px">

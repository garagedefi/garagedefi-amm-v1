...
import { Button, CardBody, Text } from '@flash-swap/uikit'
    ...
    <Container>
      ...
      <AppBody>
        <PageHeader
          ...
          description={TranslateString(1168, 'Add liquidity to receive LP tokens and earn swap fees')}
        >
          <Button id="join-pool-button" as={Link} to="/add/CRO" mb="16px">

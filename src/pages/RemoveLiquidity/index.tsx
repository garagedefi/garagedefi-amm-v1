...
import { Button, Flex, Text } from '@flash-swap/uikit'
                      ...
                      {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsETH ? (
                            ...
                            >
                              {TranslateString(1188, 'Receive WCRO')}
                            </StyledInternalLink>
                          ) : oneCurrencyIsWETH ? (
                            <StyledInternalLink
                              to={`/remove/${
                                currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'CRO' : currencyIdA
                              }/${currencyB && currencyEquals(currencyB, WETH[chainId]) ? 'CRO' : currencyIdB}`}
                            >
                              {TranslateString(1190, 'Receive CRO')}
                            </StyledInternalLink>
                          ) : null}
                        </RowBetween>
                      ) : null}
